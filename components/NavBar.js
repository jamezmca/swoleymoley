...
export default function NavBar(props) {
    const { view, handleUpdateView } = props
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity activeOpacity={0.7} onPress={handleUpdateView(1)} style={[styles.navItem, styles.navTwo, view === 1 ? { backgroundColor: '#f8fafc' } : {}]}>
